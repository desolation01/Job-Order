...
<section class="panel actions">
    <a class="button secondary" href="/job-order-system/user/version_history?id=<?= $id ?>">View Edit History</a>
    <a class="button secondary" href="/job-order-system/user/export_pdf?id=<?= $id ?>">Export PDF</a>
</section>
