...
<head>
    <meta charset="utf-8">
    <title>Export PDF - <?= e($order['jo_number']) ?></title>
...
<main class="content">
    <div class="export-actions no-print">
        ...
        <button type="button" class="secondary" onclick="savePdfFile('/job-order-system/user/download_pdf?id=<?= $id ?>', '<?= e($order['jo_number']) ?>.pdf')">Save as PDF</button>
    </div>
